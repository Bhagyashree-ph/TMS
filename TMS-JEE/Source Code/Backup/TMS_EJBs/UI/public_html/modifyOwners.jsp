...
<f:view>
<af:document id="av"  title="Modify Owners">
  <html>
    <head>
      <meta http-equiv="Content-Type"
            content="text/html; charset=UTF-8"/>
      <title>modifyOwners</title>
    ...
    <body>
      ...
      <h:panelGroup style="pointer-evnts:all">
    <h1 id="heading">Modify Owner</h1>
    <div id="pageContainer">
    <h:form>
        <div class="search-container">
            <h:outputLabel for="ownerId" styleClass="search-label">Owner ID:</h:outputLabel>
            <h:inputText id="ownerId" styleClass="search-container-input"
                         value="#{rto.owners.ownerId}"/>
            <h:commandButton value="Search" styleClass="search-container-btn" action="#{rto.fetchByOwnerID}"/>
        </div>
     </h:form>
              <h:form>
              <div class="form-group">
                <h:outputLabel styleClass="custLabel">ID Type:</h:outputLabel>
                <h:inputText id="idType" styleClass="custInText" value="#{rto.owners.idType}"/>
                </div>
            <div class="form-group">
                <h:outputLabel for="firstName" styleClass="custLabel">First Name:</h:outputLabel>
                <h:inputText id="firstName" styleClass="custInText"
                             value="#{rto.owners.firstName}"/>
            </div>
            <div class="form-group">
                <h:outputLabel for="lastName" styleClass="custLabel">Last Name:</h:outputLabel>
                <h:inputText id="lastName" styleClass="custInText"
                             value="#{rto.owners.lastName}"/>
            </div>
            <div class="form-group">
                <h:outputLabel for="dateOfBirth" styleClass="custLabel">Date of Birth:</h:outputLabel>
            ...
            <div class="form-group">
                <h:outputLabel for="phoneNumber" styleClass="custLabel">Phone Number:</h:outputLabel>
            ...
            <div class="edit-delete-container">
                <h:commandButton value="Edit" styleClass="editBtn"
                                 action="#{rto.updateOwner}"/>
                <h:commandButton value="Delete" styleClass="delBtn"
                                 action="#{rto.deleteOwner}"/>
            </div>
             </h:form>
    </div>
